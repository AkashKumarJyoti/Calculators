...
class _LengthState extends State<Length> {
  ...
  String result = "0";
  String dropdownValue1 = "Meter (m)";
  String dropdownValue2 = "Kilometer (km)";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Row(
            children: <Widget>[
              Icon(FontAwesomeIcons.ruler, color: Color(0xFF532D60)),
              SizedBox(width: 10.0),
              Text("Length conversion",  style: TextStyle(color: Color(0xFF532D60), fontSize: 23)),
            ]
          ),
