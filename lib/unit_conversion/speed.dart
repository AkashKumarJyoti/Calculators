...
class _SpeedState extends State<Speed> {
  ...
  String result = "0";
  String dropdownValue1 = "Meter/second (m/s)";
  String dropdownValue2 = "Kilometer/hour (km/h)";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Row(
              children: <Widget>[
                Icon(Icons.speed, color: Color(0xFF532D60)),
                SizedBox(width: 10.0),
                Text("Speed conversion",  style: TextStyle(color: Color(0xFF532D60), fontSize: 23)),
              ]
          ),
